...
class tile_latency_analysis(PE_latency_analysis):
    def __init__(self, SimConfig_path, read_row=0, read_column=0, indata=0, rdata=0, inprecision = 8,
                 PE_num=0, default_inbuf_size = 16, default_outbuf_size =4,device_type='none',xbar_size=[0,0],mix_mode=1,special_cycle=0):
        ...
        #linqiushi modified
        #device_type: NVM/SRAM
        #xbar_size
        PE_latency_analysis.__init__(self, SimConfig_path, read_row=read_row, read_column=read_column,
                                     indata=indata, rdata=rdata, inprecision=inprecision, default_buf_size = default_inbuf_size,device_type=device_type,xbar_size=xbar_size,mix_mode=mix_mode)
        ...
        if special_cycle!=0:
            #MM
            self.tile_latency=self.tile_latency*special_cycle
