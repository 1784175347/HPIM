...
def train_net(net, train_loader, test_loader, device, prefix):
    ...
    for epoch in range(EPOCHS):
        ...
        torch.save(net.state_dict(), os.path.join(os.path.dirname(__file__), f'zoo/{prefix}_99bitpim_params.pth'))
...
def fake_train_net(net, train_loader, test_loader, device, prefix):
    global tensorboard_writer
    torch.save(net.state_dict(), os.path.join(os.path.dirname(__file__), f'zoo/{prefix}_99bitpim_params.pth'))
    print("finished!")
